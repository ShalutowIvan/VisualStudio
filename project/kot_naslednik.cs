...
////также конструкторы нужно прописывать также как в родителе, без них не работает наследник
//     {
...
//         public kot_naslednik() //это конструктор, название конструктора всегда соответствует названию файла и названию класса, то есть название класса файла равно названию конструктора, и дополнительно дописываем скобки как у функций. Так пишется конструктор
...
//         {
//             this.Health = health;//аксессору присвоили параметр из конструкт
...
//         public void pasport()
//         {
//             this.FIO = "saimon";//обратились к переменной с protected и ошибки не было, обращаться можно как через this. и название переменной, так и через base. и название перемен
//             теперь у нас есть поле которое можно редактировать как в основном классе так и в классе наследникеке
